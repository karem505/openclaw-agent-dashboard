...
const AUTH_TOKEN = '3a1a535cfe5a9bcf6f5f24394e1a442c13353bb363d6e09b';
const WORKSPACE = '/home/ec2-user/clawd';
const TASKS_FILE = path.join(__dirname, 'tasks.json');
const SKILLS_DIR = path.join(WORKSPACE, 'skills');
const MEMORY_DIR = path.join(WORKSPACE, 'memory');
const SESSIONS_FILE = '/home/ec2-user/.openclaw/agents/main/sessions/sessions.json';
const SUBAGENT_RUNS_FILE = '/home/ec2-user/.openclaw/subagents/runs.json';
const MAX_BODY = 1 * 1024 * 1024; // 1 MB
const MAX_UPLOAD = 20 * 1024 * 1024; // 20 MB for file uploads
const ATTACHMENTS_DIR = path.join(__dirname, 'attachments');

// --- Cron Config ---
const CRON_STORE_PATH = path.join(process.env.HOME || '/home/ec2-user', '.openclaw', 'cron', 'jobs.json');
const CRON_RUNS_DIR = path.join(process.env.HOME || '/home/ec2-user', '.openclaw', 'cron', 'runs');
...
const HOOK_TOKEN = '8793857d75b6b289fb7154b811d501068c7d000d0b6d4583';
  ...
  if (method === 'POST' && segments.length === 3) {
    return readBody(req, MAX_UPLOAD * 1.4).then(buf => { // base64 is ~1.33x larger
      ...
      if (body.filePath && typeof body.filePath === 'string') {
        ...
        // Security: only allow files from /tmp, workspace, or /home/ec2-user
        const allowedPrefixes = ['/tmp/', '/home/ec2-user/clawd/', '/home/ec2-user/openclaw/'];
